...
sexo = None
edad = None
ruta_puntaje = "../Puntaje/puntaje.txt"
valores = []
...
def evaluar_texto(texto):
    ...
    niveles = {
        0: ["interesado en actividades", "participación normal", "disfruto de mis actividades"],
        1: ["interés ligeramente reducido", "ocasionalmente menos involucrado"],
        2: ["interés bajo de vez en cuando", "poco interés en actividades"],
        3: ["interés significativo en actividades", "frecuentemente desinteresado"],
        4: ["gran pérdida de interés en actividades", "no disfruto de mis actividades"],
        5: ["sin interés en ninguna actividad", "totalmente desinteresado"],
        6: ["totalmente indiferente", "completamente desmotivado", "sin interés en nada"]
    }
...
# Evaluar el texto
current_dir = os.path.dirname(os.path.abspath(__file__))
ruta_texto = os.path.join(current_dir,"..","..","modulos_seniales","Audios","AudioPregunta_8.txt")
